...
// Get customer display name (company name preferred, contact person as fallback)
    ...
    tableBody.innerHTML = currentCustomers.map(customer => `
        <tr class="hover:bg-gray-50">
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm font-medium text-gray-900">${customer.company_name || 'Kein Firmenname'}</div>
